...
<body class="text-center" style="background-color: #E7E7E7; font-family: 'Montserrat';">
            ...
            <div style="position: absolute; z-index: 10;">
                <div style="position: absolute; z-index: 10;">
                    <button type='button' style="color: #000000; position: absolute; left: 4px; top: 0;"
                        class='btn center-block text-center btn-editar-usuario' data-bs-toggle='modal' data-perfil-id=0
                        data-bs-target='#crear_Modal'>
    ...
    <div class="table-container">
        <div class="col-lg-11">
                ...
                <tbody style="background-color: #FFFFFF">
                    ...
                    foreach ($listperfiles as $registro) {
                        ...
                        <tr>
                            ...
                            <td>
                                    ...
                                    <div style="position: absolute; z-index: 10;">
                                        <button type='button' style="color: #000000; position: absolute; left: 4px; top: 0;"
                                            ...
                                            data-perfil-id=0 data-bs-target='#editar_Modal_0'>
                            ...
                            <td>
                                <form method="post" action="eliminarForm">
                                    <input type="hidden" name="op" id="op" value="eliminar">
                                    <input type="hidden" name="IDPerfil" value="<?php echo $registro['IDPerfil'] ?>">
                                    <button type="button" class="btn"
                                        onclick="confirmarYEliminar('<?php echo $registro['IDPerfil']; ?>')"><i
            ...
            <script>
                function confirmarYEliminar(IDPerfil) {
                    var confirmacion = confirm("¿Estás seguro de que deseas eliminar este Perfil?");
                    if (confirmacion) {
